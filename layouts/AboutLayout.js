...
export default function AuthorLayout({ children }) {
  return (
    <>
      ...
      />
      <div className="shadow-md dark:shadow-lg rounded-xl border border-white border-opacity-10 pt-3 sm:pt-5 pb-10 px-4 sm:px-10 backdrop-filter backdrop-blur-xl bg-white bg-opacity-10 dark:border-dark-card dark:border-opacity-10 dark:bg-dark-card dark:bg-opacity-50 ">
        <div className="pt-6 pb-8 space-y-2 md:space-y-5">
          ...
          <p className="text-sm sm:text-md md:text-lg leading-6 sm:leading-7 text-gray-700 dark:text-gray-300">
