  ...
  return (
    <>
      ...
      <div className="shadow-md dark:shadow-md rounded-xl border border-white border-opacity-10 px-4 pt-3 pb-8 md:py-5 md:px-10 backdrop-filter backdrop-blur-xl bg-white bg-opacity-10 dark:border-dark-card dark:border-opacity-10 dark:bg-dark-card dark:bg-opacity-50 flex flex-col items-start justify-start md:justify-center md:items-center md:flex-row md:space-x-6 md:mt-24">
        ...
        <div className="shadow-lg dark:shadow-lg rounded-xl border border-white border-opacity-10 px-4 py-3 md:p-5 backdrop-filter backdrop-blur-xl bg-white bg-opacity-20 dark:border-dark-card-light dark:border-opacity-10 dark:bg-dark-card-light dark:bg-opacity-10 flex flex-wrap max-w-lg">
