...
For example, the following frontmatter will display the authors given by `data/authors/sugam-budhraja.md`.
...
.highlight-line {
  @apply -mx-4 bg-gray-700 bg-opacity-50 border-l-4 border-primary;
}
