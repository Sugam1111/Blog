  ...
  return (
    <>
      ...
      <div className="items-start h-auto py-10 space-y-2 xl:grid xl:grid-cols-6 xl:grid-rows-6 xl:gap-x-8">
        <div className="drop-shadow-lg col-span-4 row-span-3 pl-5 text-4xl sm:text-5xl md:text-7xl font-extrabold text-gray-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-r dark:from-cyan-ct dark:to-purple-ct">
